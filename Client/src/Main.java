...
// проверяем условие выхода из соединения, если введено слово quit то выходим
...
// если успел забираем ответ из канала сервера в сокете и сохраняем её в dis переменную,  печатаем на свою клиентскую консоль
                        System.out.println("reading...");
                        String in = dis.readUTF();
                        System.out.println(in);
                    }
